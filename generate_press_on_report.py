...
instance = json.loads((base / 'instance-global-press-on-nails.json').read_text())
(base / 'report-global-press-on-nails.html').write_text(
    html.replace('window.__DASHBOARD_DATA__', json.dumps(instance, ensure_ascii=False, indent=2))
)
print('generated report-global-press-on-nails.html')
